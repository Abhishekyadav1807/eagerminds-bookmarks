...
export function SignupForm() {
  ...
  async function onSubmit(values: SignupFormValues) {
    ...
    void sendWelcomeEmailAction(parsed.data.email);
  ...
  return (
    <AuthCard
      ...
      description="Sign up for EagerMinds bookmarks"
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
        ...
        {successMessage && (
          <p
            role="status"
            className="rounded-lg border border-green-200 bg-green-50 px-3 py-2 text-sm text-green-700 dark:border-green-900/50 dark:bg-green-950/50 dark:text-green-300"
          >
            {successMessage}
          </p>
        )}
